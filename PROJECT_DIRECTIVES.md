...
**v5 8곡 전체 평가 — 진행 중 (2026-03-04 17:30 기준 6/8 완료)**:

파이프라인 처리 현황 (로그 기반):

| 곡 | BPM | 보컬분리 | CREPE | 후처리 노트 | MusicXML 노트 | 참조 노트 | 상태 |
|----|-----|---------|-------|------------|--------------|----------|------|
| Golden | 123 | cache HIT | 완료 | 431 | 348 | 588 | 완료 |
| IRIS OUT | 136 | 완료 | 완료 | 523 | 389 | 734 | 완료 |
| 꿈의 버스 | 172 | cache HIT | 완료 | 501 | 482 | 477 | 완료 |
| 너에게100퍼센트 | 161 | 완료 | 완료 | 552 | 526 | 649 | 완료 |
| 달리 표현할 수 없어요 | 123 | 완료 | 완료 | 1028 | 686 | 607 | 완료 |
| 등불을 지키다 | 112 | 완료 | 진행중 | - | - | - | CREPE |
| 비비드라라러브 | - | - | - | - | - | - | 대기 |
| 여름이었다 | - | - | - | - | - | - | 대기 |

참고: CREPE on CPU ~25분/곡. 전체 8곡 약 4시간 소요.
메트릭 결과는 전곡 완료 후 results/v5_full.json에 기록 예정.

**다음 방향**:
- v5 전곡 평가 완료 후 메트릭 분석
